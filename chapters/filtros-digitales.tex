...
\begin{figure}[H]
  \centering
  \includegraphics[width=300pt]{images/filtros-digitales/distorsion.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=300pt]{images/filtros-digitales/bode-lp.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/filtros-digitales/enfoques.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/filtros-digitales/freq_analog.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/filtros-digitales/freq_digital.png}
...
Esta práctica implica verificar la ubicación de los polos y ceros para garantizar que el filtro sea estable. Las respuestas al impulso y al escalón se analizan para entender cómo el filtro responde a diferentes entradas y para asegurarse de que no haya comportamientos indeseados o inestables. Al final del documento, en la sección de Apéndices se pueden encontrar los scripts utilizados para realizar las gráficas de esta sección: \ref{code:script_pz} para Polos y Ceros, y \ref{code:script_impulse_step} para Respuestas al Impulso y al Escalón.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=300pt]{images/filtros-digitales/bode-bp.png}
